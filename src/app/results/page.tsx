      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-8 md:px-6">
        <section className="panel-hero">
          <div>
            ...
            <h1 className="mt-3 text-3xl font-bold md:text-5xl">실거래가 기준으로 바로 살펴보는 결과입니다</h1>
            <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-200 md:text-base">내 예산과 규칙 가정을 먼저 요약한 뒤, 실제 구매 가능 후보를 `단지 + 전용면적 타입` 단위로 보여드립니다.</p>
          </div>
